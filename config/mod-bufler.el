;;; mod-bufler.el --- Configure bufler -*- lexical-binding: t; -*-

;;; Commentary:

;; `bufler' implements a buffer list using `magit-section', which is quite nice.
;; Configuring it is a bit hard, so the settings below involved a lot of trial
;; and error.
;;
