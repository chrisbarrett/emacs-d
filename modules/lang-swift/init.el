...
(use-package swift-ts-mode :ensure nil
  ...
  :hook (swift-ts-mode-local-vars-hook . eglot-ensure)
  :config
...
(use-package apheleia
  ...
  :config
  (add-to-list 'apheleia-formatters '(swift-format . ("xcrun" "swift-format" "format" "-")))
  (alist-set! apheleia-mode-alist 'swift-ts-mode 'swift-format))
