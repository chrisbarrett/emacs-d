;;; lib.el --- Input methods library -*- lexical-binding: t; -*-

;;; Commentary:

;; Provides the +quail-defun macro for defining quail keys that execute
;; arbitrary Lisp forms instead of simple character insertion.
