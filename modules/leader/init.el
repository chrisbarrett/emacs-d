;;; leader-init.el --- Leader key bindings -*- lexical-binding: t; -*-

;;; Commentary:

;; Hierarchical keymaps under SPC (and M-m fallback) for accessing commands.
;; Requires general.el (installed via evil module).
...
(+define-leader-keys :prefix "SPC" ;; root-level
  ...
  "'" (general-predicate-dispatch #'separedit
        ...
        (and (derived-mode-p 'markdown-mode)
             (fboundp 'gfm-pretty-tables--block-at-point)
...
(+define-leader-keys :prefix "SPC t" ;; toggles
  ...
  "d" '(dimmer-mode :wk "unfocused window dimming")
