...
- [ ] 1.1 Add `lang-markdown/gfm-pretty-callouts-bare-blockquote-body-prefix`
...
- [ ] 1.2 Run `make test-quick` and confirm the new test fails.

## 2. Implementation

- [ ] 2.1 In `lisp/gfm/gfm-pretty-callouts.el`, extend the body-prefix branch
...
- [ ] 2.2 Run `make test-quick` and confirm the new test passes.
...
- [ ] 3.3 With point on the bare-`>` line in the selected window, confirm
