...
- [ ] 1.5 Run `make test`. Full ERT suite passes, including narrowing-regression tags. Any failure here is unambiguously a pass-1 file-split error.
- [ ] 1.6 Commit pass 1 as a distinct commit: `gfm-pretty: split borders.el into borders + engine`.
