...
- [x] 1.1 Write a failing test asserting
...
- [x] 1.2 Implement `gfm-pretty-links--in-code-p` delegating to
      `markdown-code-block-at-pos` and
      `markdown-inline-code-at-pos-p`

## 2. Filter integration

- [x] 2.1 Write failing tests asserting:
...
- [x] 2.2 In `gfm-pretty-links--blocks-in-range`, reject any
...
- [x] 3.1 `make test-quick` passes
- [x] 3.2 `make test` passes
- [x] 3.3 Manual check in a real markdown buffer with a fenced
