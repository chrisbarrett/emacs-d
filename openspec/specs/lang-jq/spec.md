# lang-jq Specification

## Purpose

Editing support for the `jq` JSON query language. Provides `jq-mode` for
`.jq` files and an interactive jq filter binding for JSON buffers.
