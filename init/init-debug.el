;;; init-debug.el --- The built-in debugger for the Emacs Lisp runtime -*- lexical-binding: t; -*-
...
(use-package debug
  :functions (debugger-frame-clear debugger-frame debugger-record-buffer)
  ...
  :general-config (:keymaps 'debugger-mode-map
                   :states 'normal
